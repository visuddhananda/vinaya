...
- ## 최신 내용 혹은 편집 중
	- 삔다빠다 줄에 서 있을 때 담요를 몸을 두르면 범계인가?
		- #우꾸마라 범계는 아니고 승원 규범이다. 승원 밖에서도 탁발갈 때 써도 범계는 아니고 '적절치 않은 행위'다. 옷이 땅바닥에 닿기도 하고 보기에 안 좋기 때문. 그리고 지도법사가 이야기했는데 (아마도 일부러 의도를 가지고 하는 걸 뜻하는 듯) 무시하고 하면 둑까따 아빳띠
		- #스리랑카빅쿠 범계가 될 수 없다. 재가자들 신심을 떨어뜨릴 수 있으므로 하는 규범이다.
		- #미얀마빅쿠 승원 안에서 쓰면 범계는 아니다. 하지만 승원 밖에서 탁발할 때 쓰면 둑까따 아빳띠다. 붓다께서는 다섯조각으로 나뉜 가사만 허용하셨는데 이거는 다섯조각으로 나눠져 있지 않아 재가자 옷과 비슷하기 때문이다. (우꾸마라 사야도는 이 의견에 대해 이 천은 가사가 아니고 여벌 천에 해당하기 때문에 그렇게 볼 수 없다고 하심. 생각해봐도 재가자 옷과 비슷하다면 승원 안에서 쓰는 것이 왜 허용되는지 알 수 없음)
		- 배경설명: 승원에서 앞으로 삔다빠다 줄에서 담요를 두르고 오지 말라고 공지했다. 그동안 빅쿠들이 춥다고 담요를 두르고 와서 그거에 대한 말이 나온 모양. 우꾸마라 사야도는 마하테라들 조차도 삔다빠다 줄에서는 탁발 복장을 하고 나중에 담요를 두른다며 보기 좋지 않다고 이야기하심.
	- 강황은 음식인가 약인가?
		- #우꾸마라​ 약이다.
	- 만약 개를 손을 들어 위협한다면 둑까따인가?
		- #우꾸마라 조건에 따라 다르다. 만약 그냥 쫓아 버리려는 의도로 손을 들었다면 범계 아님. 만약 정말 때리려고 위협하고 개들도 이해한다면 둑까따.
	- 빅쿠가 재가불자를 치료해도 되는가?
		- #담마다야다 빅쿠가 재가불자를 치료하는 일은 적절하지 않습니다.
		- 배경설명: 이번에 한의 중국 빅쿠가 양곤으로 떠난다고 합니다. 가는 김에 환자들을 봐준다는데요. 우리 빅쿠가 그 한의사 재가자 전립선 문제가 있다고 그 재가자도 데리고 가면 안되냐 합니다. 그 재가자가 발우 드는 일도 가끔 하고 한국 노인들 봐주기는 했는데요. 그 중국 빅쿠를 직접적으로 도운 적은 없습니다. 1. 이럴 때 치료를 부탁하는게 적절한지 2. 그 재가자를 치료해줘도 그 중국 빅쿠의 계에 문제가 없는지 궁금합니다.
	- 발우 뚜껑 교환 가능 여부
		- 발우 굽는 과정에서 제 발우 뚜껑과 다른 사람 발우 뚜껑이 바뀌었나 봅니다. 발우는 새로 구하면 닛사기야 빠찟띠야로 알고 있는데요. 뚜껑은 문제 없나요?
	- 온라인으로 셰얄레이들을 출가시킬 수 있는가?
		- #우꾸마라 있다. 내가 온라인으로 오계를 주고 재가자들이 받는 것처럼 셰얄레이가 십계를 받으면 된다.
		- 배경설명: 법문 질의 응답 시간에 자기 나라에는 적절한 테라와다 승원이 없고 머물 곳이 마땅치 않다며 온라인으로 10계를 받아 출가하면 안되냐는 질문을 해왔음. 10계를 깨지 않을 의도로 염색된 옷을 입고 계를 받으면 된다고 함.
			- #출처 : The Buddha and his Great Disciples-(4)Venerable Mahakassapa(4)
	- 계란을 삶는 것은 살생인가?
		- #우꾸마라 파욱 사야도지께  특별한 밥들과 계란이 보시된 적이 있다. 그 때 '파욱 사야도지께서 대부분 계란들이 다 죽었다고 해도 1~2개에 생명이 있을 수 있지 않는가'라고 말씀하셨다.
		- 배경설명: 법문 시간 질의 응답 시간에 과연 온라인으로 오계를 받아도 되는가? 그들 중에 계란들을 삶는 사람들이 있는데라는 질문이 나왔음(살생계를 미래에 어길 거면서 계를 받아도 되느냐는 취지) . 우꾸마라 사야도는 웃으시면서 나는 잘 모르겠다며 계란을 요리하는 셰얄레이들은 어떻게 생각하냐고 말씀하심. 그러면서 위의 파욱 사야도지 이야기를 해주셨음. #출처 : The Buddha and his Great Disciples-(4)Venerable Mahakassapa(4)
		- 전에 우꾸마라 사야도께 질문했을 때도 계란을 먹어도 된다 안된다 두 가지 아이디어가 있다고 설명해주심. 빅쿠들이 계란을 삶을 일은 없지만 빅쿠들에게는 이것을 받느냐 안 받느냐가 이슈가 됨. 삥우린에서는 계란을 거의 아침마다 공양하고 있음. 난 안 받음.
- ## 🍴공양간에서
	- 물엿(음식)이 들어간 홍삼 캔디는 음식인가? 약인가?
		- #우꾸마라 물엿이 오직 캔디를 단단하게 만들 목적이라면 7일 강장제이다.
		- 배경설명: 베트남 빅쿠가 홍삼 캔디를 가져와서 이것이 음식인지 7일 약인지 물었습니다. 안의 내용을 보니 설탕이 있어서 저는 7일 약이라고 답해주었습니다. 그런데 옆에 물엿도 포함되어 있었습니다. 각설탕의 예를 보면 밀가루라 섞였다 해도 7일 약인데요. 물엿도 마찬가지인가요?
			- 각설탕의 예 #우꾸마라
			...
			- Q 그럼 홍삼 캔디 사례는 어떤가?
				- 사실 (물엿같이) 쌀(성분)이 섞였다면 야와깔리까라 아침만 되는 것이다. 하지만 이것이 오직 단단하게 만드는 목적이라면 그럼 7일 강장제로 여겨질 수 있다. 하지만 어떤 사람들은 의심이 있을 수 있기 때문에 (물엿같은 것과 비슷한) 쌀 파우더 등으로 만들어진 건 (아침빼고)안 먹는다.
				- 추가질문: 왜 음식 + 약인데 7일 강장제가 되는지는 잘 모르겠습니다. 음식이면 음식이고 약이면 약이어야 하는 듯 한데요.
					- #담마다야다 소량의 밀가루가 사탕을 굳게 하는 역할을 한다면 비록 밀가루가 음식으로 분류되지만 그 밀가루가 섞인 사탕은 칠 일 약으로 여긴다는 뜻입니다. 물엿도 마찬가지입니다.
					- 그런데 물엿의 양이 얼마나 섞였는가의 문제가 생깁니다. 물엿이 음식으로 분류되는가 설탕처럼 칠 일 약으로 분류되는가부터 확인해야 함. 음식이라는 의견이 있음. 그렇다면 물엿이 소량의 밀가루와 같은 역할을 하는가를 알아봐야 한다는 뜻임.
					- 물엿이 음식으로 분류되고 다량 함유되었다면 그 사탕은 음식으로 분류되고 소량으로 밀가루와 같은 역할을 한다면 칠 일 약으로 분류될 것임. 물엿이 음식인가 여부, 어느 정도로 섞였는가 문제 등을 따져봐야 할 듯합니다.
	...
	- 블랙커피가 오후에 허용되는가?
		- 미얀마에선 허용안된다. #우꾸마라
		- 스리랑카에선 저녁에 허용된다. 설탕과 같이 섭취 가능 #스리랑카빅쿠
	- 이 컵은 허용되는가?
	...
	- 로얄디는 강장제인가 주스인가?
		...
		- #미얀마빅쿠 다른 빅쿠에 따르면 율장 법사 사야도가 포도당은 약으로 볼 수 있지만 다른 화학 성분들이 섞였기에 7일이라고 했다고 한다. 하지만 의사 빅쿠에게 물어보니 포도당도 일종의 당이라고 하니 7일 약인 듯 하다.
	...
	- 타미린드 플레이크(말린 조각)가 나왔다. 식용인가 7일 혹은 평생 약인가?
		- ![2024-04-02-19-06-12.jpeg](../assets/2024-04-02-19-06-12.jpeg)
	...
	- 반떼, 깝삐야가 식당에서 메뉴를 물었을 때 예스를 대답할 수 있나요?
		- 배경설명: 오늘 병원갈 때 택시 드라이버가 깝삐야 역할을 했습니다. 아침 공양 때 식당에서 '모힝가?' 라고 물어보길래 '오케이' 라고 했는데요. 이럴 때 대답해도 되는건가요? 제 필수품은 아니지만 나중에 숩뻬살라 빅쿠가 필수품을 낼 것은 알고 있었습니다. 그러나 승원 가서 정산(?)이 되는거고 지금은 깝삐야의 필수품으로 마련하는 것입니다.
			- #담마다야다 이런 경우는 가능합니다.
- ## 🏛️승원에서
	- 허리띠를 안 매면 범계
...
- ## 🛖꾸띠에서
	- 올리고당이 포함된 약의 허용기간은?
		- ![2025-12-06-20-27-51.jpeg](../assets/2025-12-06-20-27-51.jpeg)
		- 프로바이오틱스에 올리고당이 함유되어 있다. 이 경우 7일인가? 평생 약인가?
		- #담마다야다 확답하기 어려움.
		- #우꾸마라 사실 이게 뭔지 모르겠다.(미얀마엔 올리고당 개념이 없고 해당 상품도 없는 듯. 사야도께 보여드린 번역도 정확한 번역이 아닌 듯) 이런 종류의 당은 7일로 여겨지지만 다르게 여겨지는 것도 있어서 나도 모르겠다. (당이 만들어진) 소스를 모르겠다. 의사에게 물어보는게 좋겠다. 어떤 설탕은 (저런 식일 때 약으로) 허용된다. 왜냐면 진짜 설탕이 아니기 때문이다. 어떤 것들은 그냥 냄새, 향을 위한 것이지 실제 설탕은 아니다. 그렇다면 괜찮다.
			- 생각해봐야할 것이 있다. 국에 알코올을 특정 용도 때문에 넣더라도 향이나 맛이 다 날라가면 허용이 된다. 그런 것처럼 설탕이 주 성분이 아니고 약이 훨씬 많다면(obvious) 허용된다고 생각한다. 자그리(?), 쌀 파우더처럼.
			- 추가질문: 그럼 포도당(glucose)은 어떤가?
				- #우꾸마라 그것도 의심도 있고 허용된다는 의견도 있는데 나도 확답할 수 없다. 소스가 무엇인가?
	- 반떼, 전에 세나니승원에서 보내주신 약에 옥수수 전분이랑 토마토가 포함되어 있는데 섭취 가능한 약인가요?
		- ![2025-10-31-15-10-13.jpeg](../assets/2025-10-31-15-10-13.jpeg)
			- 옥수수, 쌀겨, 토마토 등이 있는 것으로 봐서 약으로 사용하기에는 적절하지 않은 듯합니다. #담마다야다
...
- ## 🪷법당에서
	- 비난하는 빅쿠를 다루는 절차에 대해
		- 빠띠목카에서 빅쿠들이 모여 있을 때 한 빅쿠가 사야도의 교계 후 공개 비판했다. 그 후 사야도가 미얀마 빅쿠들에게 세 번 묻고 미얀마 빅쿠들 또한 대답했다. 이것은 무슨 절차인가?
			- #스리랑카빅쿠  정식 00깜마가 아니고 00깜마라는 동의를 구하는 깜마이다. 사실 그 빅쿠가 적절하지 않은 것. 그가 사야도보다 주니어였기 때문에 사야도께 동의를 구하고 의견을 말했어야 했다.
			- 배경:
				- 오늘 빠띠목카 후에 미얀마 빅쿠들간 불화가 있었습니다.
					- 우꾸마라 사야도께서 빠띠목카 후에 앞으로 새벽 시간에 새건물 담마기리 위하라에 와서 찬팅도 하고 수행하고 가라고 교계를 하셨습니다. 그런데 갑자기 우꾸마라 사야도보다 더 법랍이 낮은 사야도 한 명이 일어나서 비난하는 식으로 큰 목소리로 따지셨습니다. 다른 빅쿠들이 손을 잡으며 말렸지만 계속 뭐라고 하셔서 몇 분 간 소동이 계속 됐습니다.
					- 그러자 우꾸마라 사야도께서 미얀마 말로 뭐라고 하시며 전체에게 말하자 미얀마 빅쿠들이 대답했습니다. 이런 식으로 3번을 반복했습니다. 동의를 구하는 절차로 보였습니다.
...
- ## 💽기타
	- 반떼, 빅쿠가 아픈 경우 재가자로부터 초대받지 않는 상황에서 진찰을 요청할 수 있나요?
		- #담마다야다 아픈 빅쿠는 재가불자의 초대를 받지 않아도 약을 요청할 수 있습니다. 진찰도 가능할 수 있을 것입니다. 어디까지나 재가불자가 흔쾌히 지원해 주는 상황이라야 가능할 것입니다. 그러니 미얀마 어느 정도까지 가능한 지 미얀마 반떼들에게 조언을 구해 보는 것이 좋습니다.
	- 반떼, 까티나 허용 시작시간은 정확히 언제인가요? 제가 알기로는 행사 여부와 관계없이 와사 종료 시점(바로 오늘 여명)인 것으로 아는데 맞는지요?
		- #담마다야다 닛삭기야 빠찟띠야 1번은 까티나에 참석 여부와 관계 없이 혜택이 있으나 2번은 까티나 행사에 참석하지 않았다면 계율 적용을 받는다고 되어있습니다.
	- 반떼, 재가자에게 라디오를 줄 수 있나요? 이건 가루반다 인가요 라후반다 인가요?
		- 라디오가 상가 소유라면 가루반다인가 라후반다인가 따져야 합니다. 상가 소유는 라루반다든 라후반다든 개인 빅쿠가 함부로 처리하지 않는 것이 좋습니다. 어쨌든 개인 소유라도 재가자에게 뭔가를 주는 경우는 조건이 맞아야 합니다. 부모, 깝삐야인 경우는 줄 수 있고, 그외는 그냥 주는 것은 여법하지 않습니다. 일을 시키고 줄 수 있는 경우도 있습니다. 왜 주려고 하는지 이유를 알아야 합니다. #담마다야다
	- 반떼, 재가자에게 임플란트 필수품 가격을 물어봐도 되나요?
		- 가격 물어보는 것은 괜찮습니다. #담마다야다
	...
	- 어제 저녁에 모든 빅쿠들에게 동의를 받았는데 무엇을 위한 동의인가?
		- 시마 설치를 위한 찬다를 주는 것. 너의 스승 담마다야다도 시마를 설치하려 하고 있다. 깜마에 참석하지 않는 빅쿠들은 이렇게 찬다를 줘야 한다. #우꾸마라
			...
			- ![IMG_20240211_190126.jpg](../assets/IMG_20240211_190126_1756687344629_0.jpg)
- ---
-